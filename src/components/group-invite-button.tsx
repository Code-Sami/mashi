...
export function GroupInviteButton({ shareUrl, groupName, helperText, buttonLabel = "Invite Friends" }: Props) {
          ...
          <div className="mt-2 flex gap-2">
            ...
            {"share" in navigator ? (
              <button
                ...
                onClick={async () => {
                  await navigator.share({ title: `${groupName} link`, text: `Join my group on Mashi: ${groupName}`, url: shareUrl });
                }}
              >
                Share
              </button>
